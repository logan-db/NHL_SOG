...
solidify_tables("gold_player_stats", "gold_player_stats_delta_v2")
solidify_tables("gold_game_stats", "gold_game_stats_delta_v2")
solidify_tables("gold_model_stats", "gold_model_stats_delta_v2")